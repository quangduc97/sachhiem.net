...
<a href="/TONGIAO/BNVNCB05">&nbsp;5</a> </p>
	...
	<p class="CHUONG">
	<a name="24">CHƯƠNG</a> 24: </p>
	<p class="TuaChuong">
	HÀNG THÌ SỐNG CHỐNG THÌ CHẾT</p>
	
	<p>
	Trong sách Giô ên chỉ có hai câu đáng chú ý, tôi xin phép luợc qua thôi :</p>
	<p>
	<font face="Symbol">·</font> 
	Ôi ngày ấy ! vì ngày đức Giê hô va đã gần ! Nó đến như một tai vạ thả ra 
	bởi đấng toàn năng (1:15) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	trược này; huống chi trở thành tiên thánh !</p>
	<p>
	...
	âm muu độc địa trên hoàn vũ này !</p>
	<p>
	...
	cho bản thân !!!</p>
	<p>
	Bây giờ, xin mời quý vị cùng học <b>sách A mốt :</b></p>
	<p>
	Ngài này dùng một dạng văn đặc biệt như xử án; đọc nghe hay hay :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	qua Ki ro làm phu tù. Đức Giê hô va phán vậy. (1:2-5) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	nguời A mô rít làm sản nghiệp (2:7-10) </p>
	<p>
	...
	NGÀI LÀ GIÊ HÔ VA ĐỨC CHÚA TRỜI VẠN QUÂN. (4:6-13) </p>
	<p>
	...
	thân", để "muôn kiếp làm tôi tớ" ???</p>
	<p>
	<font face="Symbol">·</font> 
	...
	trong nhà Giô sép, ở Bê tên không ai có thể tắt đuợc.(5:4-6) </p>
	<p>
	Đến đây, tôi mới LÒI CÁI DỐT của tôi ra. Tủi hổ, tủi hổ !!! </p>
	<p>
	...
	Nhưng , biết MUỘN CÒN HƠN KHÔNG, tôi tự an ủi.</p>
	<p>
	<font face="Symbol">·</font> 
	...
	NGÀI LÀ ĐỨC GIÊ HÔ VA VẠN QUÂN !!!</p>
	<p>
	<font face="Symbol">·</font> 
	...
	từng mảnh.(6:8-11). </p>
	<p>
	<font color="#606060">(The Lord hath sworn by himself, saith the Lord the God of host. I abhor the 
	...
	will smite the great house with breaches, and the litle house with clefts)</font></p>
	<p>
	...
	từ đó xuống. (9:1-2). <font color="#606060">(I saw the Lord standing upon the altar; and he said: 
	...
	though they climb up to heaven, thence will bring them down). </font> </p>
	<p>
	Câu dịch trên đây, hình như né tránh, không đủ mạnh theo ý chính; do vậy xin 
	đề nghị lại : “Ta thấy Chúa đứng trên bàn thờ, và phán : "<i>Hãy đập trên cái 
	...
	trèo lên trời, ta
	cũng lôi đầu xuống". Nghia là, Chúa trời "thật sự nhổ cỏ tận gốc</i>". Đọc 
	...
	những "<i>sự nhiệm mầu Thiên chúa</i>", và "Chúa đầy thương yêu", nó nằm ở chỗ nào; 
	hay chính là chỗ GIẾT SẠCH, ĐỐT SẠCH, CƯỚP SẠCH ???</p>
	<p>
	...
	muôn vạn kiếp về sau" !!!</p>
	<p class="center">
	***050725*** </p>
	
	
	<p class="CHUONG">
	<a name="25">CHƯƠNG</a> 25: </p>
	<p class="TuaChuong">
	CHÚA GHEN NÊN CHÚA BÁO THÙ</p>
	...
	bạo ngược. Xin hãy kiên tâm, ánh sáng sẽ loé ra ở cuối đường hầm.</p>
	<p>
	<span class="First">B</span>ây giờ, chúng ta hãy HỌC thêm về <b>lời tiên tri Áp đia:</b></p>
	<p>
	<font face="Symbol">·</font> 
	...
	understanding out of the mount of Esau) </p>
	<p>
	...
	"treo đầu dê, bán thịt chó", mà thôi ! </p>
	<p>
	...
	xa Thượng đế của mình; phụng sự cho mưu đồ nham hiểm "thế gian".</p>
	<p>
	<span class="First">V</span>à để hiểu rõ thêm về những tính toán ấy, chúng ta học tiếp
	<b>sách Mi chê</b>:</p>
	<p>
	<font face="Symbol">·</font> 
	...
	hire of an harlot, and they will return to hire of an harlot.) </p>
	<p>
	...
	nó đi qua truớc mặt chúng nó, và đức Giê hô va ĐI ĐẦU chúng nó(2:13) </p>
	<p>
	...
	dùng những ngôn từ đáng ghê tởm :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	là một THẦN CHIẾN TRANH ĐỘC ÁC !</p>
	<p>
	<font face="Symbol">·</font> 
	...
	Tự do tín nguỡng; và nguời NGOẠI ĐẠO làm sao tin đuợc lời họ ?</p>
	<p>
	Xin hãy đọc và suy gẫm cặn kẽ câu này của Thiên chúa : </p>
	<p>
	<font face="Symbol">·</font> 
	...
	mouths, they even prepare war against him (Micah 3:5) </p>
	<p>
	...
	và kẻ thù nghịch của ngươi tức là nguời nhà mình.(7:5-6) </p>
	<p>
	...
	<p>
	Vị tiên tri này đã chống lại người trước ngài; đó là Thánh A Mốt :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	IN POWER, nên suy tính chuyện trả thù !</p>
	<p>
	...
	??? </p>
	<p>
	Ngài này cũng xác nhận lại quyết định bất khoan dung của đức Chúa trời :</p>
	<p>
	<font face="Symbol">·</font> 
	Ta sẽ trừ bỏ tuợng chạm và tượng đúc khỏi nhà các thần ngươi ; ta sẽ làm mồ 
	mả cho ngươi ; vì ngươi là hèn mạt (1:14) </p>
	<p>
	...
	thuộc lòng câu ấy.</p>
	<p>
	Xin lạy NGÀI, con sợ lắm, không dám nhận ngài làm CHA !!!</p>
	<p class="center">
	***050729***</p>
	
	<p class="CHUONG">
	<a name="26">CHƯƠNG</a> 26: </p>
	<p class="TuaChuong">
		ĐỂ NGHÈO MỚI CHỊU TRONG DANH</p>
	...
	Thuợng đế là một đại hung thần :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	off man from the land, saith the Lord). </p>
	<p>
	...
	dặn dò rằng, những gì không ứng nghiệm, thì không phải lời Chúa !!!</p>
	<p>
	"<i>Cọp dữ không ăn thịt con</i>" là lời truyền của dân Việt. Chắc e "trái đạo", 
	...
	HÔ VA, KHÔNG CẦU HỎI NGÀI (1:4-6) </p>
	<p>
	...
	quá ư gồ ghề, hung tợn, thì tìm đến để tự chuốc lấy khổ đau hay sao ?</p>
	<p>
	...
	cũng đe doạ, cung "láo luờng"...thì tại sao phải nhọc công tìm đến ?</p>
	<p>
	<font face="Symbol">·</font> 
	...
	cities and against the high towers). </p>
	<p>
	...
	nữa ! Nhưng nếu bỏ lời này, thì Kinh thánh lại không có giá trị sao ?</p>
	<p>
	...
	tính" mà các nhà thần học gán cho đức Chúa trời, để phân biệt rõ ràng.</p>
	<p>
	<font face="Symbol">·</font> 
	...
	Thiệt ra, phải dịch rõ là NGOAN NGOÃN mới đúng (meekness).</p>
	<p>
	...
	khác. Nhưng, trong đó có ông Trời Việt nam lại hiền hoà, dễ mến !</p>
	<p>
	<font face="Symbol">·</font> 
	...
	HÀ HƠI LÀM LINH HỒN" cho con người chứ ?</p>
	<p>
	...
	ngại mới đây chăng ?</p>
	<p>
	Xin mượn câu thơ :</p>
	<p>
	"Đừng mượn hoi hùm rung nhát khỉ, </p>
	<p>
	Lòng ta sắt đá há lung lay"</p>
	<p>
	Để tóm luợc chút tâm ý, sau khi HỌC bài này.</p>
	<p>
	***050730***</p>
	
	<p class="CHUONG">
	<a name="27">CHƯƠNG</a> 27: </p>
	<p class="TuaChuong">
	ĐÂM CON CHO THỎA LÒNG NGÀI</p>
	...
	TRỜI; đặc biệt là Ông Trời Do thái.</p>
	<p>
	...
	người; mà không hề bị TÔN GIÁO, TÍN NGƯỠNG TRÓI BUỘC.</p>
	<p>
	...
	trình bày cặn kẽ ngu ý của mình.</p>
	<p>
	Quay trở lại vấn đề "phủ dụ" nói trên, chúng ta thấy rằng: Những người đó 
	quên đi rằng, khi nói "hai là một", thì có mấy điều xảy ra:</p>
	<p>
	...
	Thiên chúa", những người này sẽ BỊ CHÚA DIỆT.</p>
	<p>
	-Hai là, khi "nâng cao các thần khác", tức là PHỤC SỰ "thần gớm ghiếc", tội 
	này cũng sẽ BỊ CHÚA DIỆT. </p>
	<p>
	...
	HOẠ DIỆT VONG. Nếu quý vị nghi ngờ lời ấy, thì xin HỌC tiếp :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	brother). </p>
	<p>
	Câu Việt dịch, lại né tránh ý chính; do đó xin đề nghị :</p>
	<p>
	...
	cỡi, và (làm cho) những nguời thân nó sẽ giết lẫn nhau".</p>
	<p>
	...
	NUỚC, KHÔNG THÀ MẤT CHÚA. Thật thấm thía vô cùng !!!</p>
	<p>
	...
	họ tin không một ai lọt luới.</p>
	<p>
	...
	CHỦ TÂM HỒN MÌNH VÀ TỰ QUYẾT ĐỊNH LẤY !</p>
	<p>
	Bây giờ, xin cùng học sách Xa cha ri :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	shall perish from Gaza, and Ashkelon shall not be inhabited). </p>
	<p>
	...
	người ta XA LÌA; người ta GHÉT BỎ ĐỜI ĐỜI.</p>
	<p>
	...
	chính xác. Do thái hiện nay, chính là bài học muôn thuở vậy ! Thưa ngài.</p>
	<p>
	<font face="Symbol">·</font> 
	...
	đời" cho Thượng đế Do thái. Ai còn chút nghi tâm, xin HỌC tiếp mấy câu này :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	dân tộc chung quanh (ngoại đạo).</p>
	<p>
	<font face="Symbol">·</font> 
	...
	là "nhân từ tối thượng" đó sao ??? Hãy nói đi !!! </p>
	<p>
	...
	ƠN CỨU RỖI CỦA CHÚA", thì danh ngài sẽ "không sáng" nữa đâu !!!</p>
	<p>
	<font face="Symbol">·</font> 
	...
	: Đức Giê hô va là đức Chúa trời tôi. (13:8-9) </p>
	<p>
	...
	***050801***</p>
	...
	<p class="CHUONG">
	<a name="28">CHƯƠNG</a> 28: </p>
	<p class="TuaChuong">
	ĐÀO TẬN GỐC, TRỐC TẬN RỄ</p>
	...
	Điều ấy sẽ không sai, nếu ai đó có thể giải thích được mấy điều sau đây :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	Jacob's brother ? saith the Lord;</p>
	<p>
	...
	cách"; mà lại đòi làm Thượng đế !</p>
	<p>
	...
	những tên "tôi mọi phương đông"!!!</p>
	<p>
	...
	say theo tiền tài và danh lợi.</p>
	<p>
	...
	cũng "không đuợc vào nhà Chúa" ! Hãy nhớ kỹ điều này !</p>
	<p>
	<font face="Symbol">·</font> 
	...
	against whom the Lord hath indignation for ever). </p>
	<p>
	...
	đốt phá. Rõ ràng là một kẻ TÔN THỜ BẠO LỰC.</p>
	<p>
	...
	Ông đã lầm to ! Và tôi tớ ông cung lầm tuốt.</p>
	<p>
	...
	or accept thy person, saith the Lord of host.) </p>
	...
	đặt ra câu hỏi và tự trả lời tại sao như thế ???</p>
	<p>
	...
	ĐỰC..để cúng tế ngài; mà chỉ tìm DÊ CÁI cho chúng !</p>
	<p>
	...
	him that offereth an offering unto the Lord of host) </p>
	<p>
	Thấy câu dịch không được rõ, xin đề nghị :</p>
	<p>
	...
	ngài mà thôi , vì ngài sinh sau Thần chúng nó!</p>
	<p>
	...
	từ truớc đến nay đều là Thánh cả sao ? Thầy Huy ơi !</p>
	<p>
	...
	với Satan mà nói chuyện SUI GIA !!! Thì ra, cũng tầm thường như :</p>
	<p>
	Đã không điều lợi, khôn thành dại,</p>
	<p>
	Hễ có đồng tiền, dở cung hay</p>
	<p>
	...
	"đại náo Satan đinh", chứ nào đâu dám "hỗn". Chuyện là zầy zầy..."</p>
	<p>
	...
	vài ngàn, trừ "con cái anh" ra ??? Chỗ SUI GIA là thế đấy !!!</p>
	<p>
	Suy nghỉ tí teo về chuyện trên đây xong, con giật mình khi đọc "</p>
	<p>
	<font face="Symbol">·</font> 
	...
	phán HIỂN LINH ! Con đâu dám bàn thêm vào chút nào nữa.</p>
	<p>
	<font face="Symbol">·</font> 
	...
	CHẲNG ĐỂ LẠI CHO CHÚNG NÓ HOẶC RỄ, HOẶC NHÀNH.</p>
	<p>
	...
	ta tưởng chừng như đức Giê hô va còn bận việc lắm, nên quên bỏ con ngài !</p>
	<p>
	...
	mọi" gọi ngài là Thượng đế "NHÂN TỪ" , "TOÀN NĂNG".</p>
	<p>
	...
	BỤI ĐẤT TRỌN CẢ ĐỜI (Sáng thế ký 3:13-14) </p>
	<p>
	...
	<p class="CHUONG">
	<a name="29">CHƯƠNG</a> 29: </p>
	<p class="TuaChuong">
	TRẦN TRUỒNG ĐÂU PHẢI XẤU XA</p>
	<p>
	...
	bừng tỉnh lại, vì tiếng giảng của Mục sư Nguyễn văn Huệ:</p>
	<p>
	...
	Chúa là con của sự sáng, con của ban ngày".</p>
	<p>
	...
	ngày thứ BA.(Sáng thế ký 1:10-12). </p>
	<p>
	<font face="Symbol">·</font> 
	...
	đúng; và sẽ dẫn đến hậu quả là Chúa không thật !!! </p>
	<p>
	2) Sáng tạo loài người và muôn loài vạn vật :</p>
	<p>
	...
	Nhưng chính câu này lại phủ định câu khác:</p>
	<p>
	<font face="Symbol">·</font> 
	Giê hô va đức Chúa trời bèn lấy bụi đất nắn nên hình nguời, hà sanh khí vào 
	lỗ mủi; thì nguời trở nên một loài sanh linh.(Sáng thế ký 2:7). </p>
	<p>
	...
	ra. Hoá ra cuộc đời con nguời không bằng cầm thú !!!</p>
	<p>
	...
	kể về ngài Thánh Môi se, người sáng tạo Thượng đế có câu :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	rồi. Còn đâu thâm tình máu mủ ???</p>
	<p>
	...
	nếu có hình tuợng, thì ai là người làm nên nó ?</p>
	<p>
	...
	A đam giống chúng, cho dễ "hoà nhập".</p>
	<p>
	...
	con nguời đó sao ??? Đó là ƠN CHÚA đó sao ??? </p>
	<p>
	Và ngay tại đây, tôi xin phép lật tẩy thầy tiến sỹ Lê anh Huy, về việc bịa 
	chuyện để lừa gạt dân lành. Thánh kinh Cựu uớc ghi rõ ràng là :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	subtil than any beast of the field which the Lord God had made). </p>
	<p>
	...
	DƯƠNG PHONG trong phim Tàu. Tủi nhục !!!!!!!!</p>
	<p>
	...
	Đây là một bịa đặt và làm nhục Thiên chúa.</p>
	<p>
	...
	***Tự hữu và hằng hữu:</p>
	...
	Huệ đã giảng.</p>
	<p>
	3) Toàn năng: tức là làm gì cũng đuợc.</p>
	<p>
	...
	sai những dân "Trời ơi đất hỡi" để làm tiên tri ???</p>
	<p>
	4) <b>Toàn trí </b>: tức là hiểu biết mọi chuyện của quá khứ, hiện tại và tương 
	lai.</p>
	<p class="sub">
	...
	rồi bắt tội thế gian đời đời, cũng là chuyện "bất tri". </p>
	<p class="sub">
	...
	nguy hại đời sống con nguời, ông cũng phải "đứng mủi chịu sào"...</p>
	<p class="sub">
	c) Tương lai : Cả quá khứ và hiện tại, lời ông đều không đúng, thì cần chi 
	phải hỏi đến tương lai ???</p>
	<p>
	5) Thánh khiết : tức là sự trong sạch, cao cả.</p>
	<p>
	...
	"hiểu thấu ngọn nguồn".</p>
	<p>
	6) Yêu thương loài nguời, muốn kết bạn gần gủi.</p>
	<p>
	...
	đổ lên đầu bọn "trần truồng và đần độn" ? </p>
	<p>
	...
	chúng tôi cần đến sự THÔNG SÁNG HIỂU BIẾT.</p>
	<p>
	...
	biết xấu hổ" của Tổ phụ A đam và Ê va ???</p>
	<p class="center">
	***050807***</p>
	
	<p class="CHUONG">
	<a name="30">CHƯƠNG</a> 30: </p>
	<p class="TuaChuong">
	THÀ GIẾT LẦM HƠN BỎ SÓT</p>
	<p>
	...
	đạo"; Nhưng họ "chống đạo nguời khác", thì họ không điếm xỉa tới !!!</p>
	<p>
	...
	những nhà độc tài" (thêm chữ "tể"; thật vô duyên)</p>
	<p>
	...
	cai trị nào cũng gian ác như nhau, tuy mức độ có cao thấp.</p>
	<p>
	...
	để điều khiển dân Do thái, chống lại vua Pharaoh của Ai cập.</p>
	<p>
	Như thế thì : GIÊ HÔ VA ĐỨC CHÚA TRỜI DO THÁI CHÍNH 
	LÀ THẦY PHÙ THỦY MÔI SE</p>
	<p>
	...
	Thượng đế. Xin đọc tiếp để thấy rõ sự nghiệp của ông :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	GẬY CỦA HỌ (Xuất Ê díp tô ký 7:10-12) </p>
	<p>
	...
	sao giải thích; bởi vì ông là ĐỒNG MÔN của tà đạo ?</p>
	<p>
	...
	lẽ cũng liên quan đến âm muu này.</p>
	<p>
	...
	buổi lễ này; nay được đọc Kinh Chúa, tôi thấy không khác là bao !!!</p>
	<p>
	...
	Do thái đi. Hãy đọc đoạn sau đây để thấy "tinh thần Thượng đế Môi se" :</p>
	<p>
	<font face="Symbol">·</font> 
	Đức Giê hô va làm cho dân sự được ơn trước mặt người Ê díp tô, nên họ bằng 
	lòng cho; và dân Y sơ ra ên LỘT TRẦN người Ê díp tô (12:36) </p>
	<p>
	...
	chúng ta cần đọc lại một số chi tiết về "phép lạ" của ông:</p>
	<p>
	<font face="Symbol">·</font> 
	...
	đặng khiến ếch nhái bò lên xứ Ê díp tô (Xuất Ê díp tô ký 8:6-7) </p>
	<p>
	Keo này cũng bị huề, vì hai bên cùng một TỔ ! Thật buồn cuời, Thượng đế mà 
	không thắng nổi Tà Ma !</p>
	<p>
	<font face="Symbol">·</font> 
	...
	thì ông Môi se khôn hơn nhiều !</p>
	<p>
	<font face="Symbol">·</font> 
	...
	CHẾT. (xuất Ê díp tô ký 12:29-30). </p>
	<p>
	...
	vẫn có "tình nguời" hơn "kẻ khác" !!!</p>
	<p>
	...
	toàn cảnh máu me hung tợn. Xin đọc thêm một câu truớc khi "giải lao":</p>
	<p>
	<font face="Symbol">·</font> 
	...
	đặng HÀNH HẠI (xuất Ê díp tô ký 12:21-23). </p>
	<p>
	...
	kẽ tiêu diệt vào nhà các ngươi đặng hành hại" !</p>
	<p>
	...
	tô, họ HÁ CHẲNG LIỆNG ĐÁ CHÚNG TÔI sao ? (xuất Ê díp tô ký 8:26). </p>
	<p>
	...
	một lời giới thiệu. Hãy tự mình ĐỌC VÀ SUY GẪM.</p>
	<p class="center">
	***050812***</p>
	
	<p class="CHUONG">
	<a name="31">CHƯƠNG</a> 31: </p>
	<p class="TuaChuong">
	SÁNG RỒI THỨC DẬY ĐI CON</p>
	<p>
	...
	việc trình bày suy nghỉ của mình.</p>
	<p>
	...
	Thiên chúa Do thái" để biết về ngài!</p>
	<p>
	...
	sau; và chỉ dựa vào Kinh thánh ấy mà thôi.</p>
	<p>
	...
	người. Cái đó, người ta gọi nó là tôn giáo, là tín nguỡng.</p>
	<p>
	...
	NGUỜI, NÊN NGÀI CÓ QUYỀN LÀM CHÍNH TRỊ" (Nguyễn học Tập)</p>
	<p>
	...
	mã", như câu vừa rồi, thì chuyện gì sẽ xảy ra ?</p>
	<p>
	...
	ngàn dân của ông, chỉ vì họ không muốn theo ông !!!</p>
	<p>
	...
	kinh; và cũng là điều mà tôi cảm thấy thắc mắc nhất. </p>
	<p>
	...
	*Không những thế, ngài còn hiện ra trong MÂY ĐEN, TRONG LỬA; chứ chưa bao 
	giờ làm việc QUANG MINH CHÍNH ĐẠI.</p>
	<p>
	...
	*Thượng đế không thể nào HỐI HẬN VIỆC DỰNG NÊN VŨ TRỤ VẠN VẬT, DỰNG LÊN LOÀI 
	NGUỜI, RỒI ĐEM HỒNG THỦY MÀ GIẾT CHẾT TẤT CẢ, CHỈ CHỪA GIA ĐINH NÔ Ê.</p>
	<p>
	...
	*Thượng đế không thể nào không biết việc mình làm :TẠO RA QUẢ ĐẤT RỒI SAU ĐÓ 
	MỚI GẮN MẶT TRĂNG, MẶT TRỜI VÀO.</p>
	<p>
	*Thượng đế không thể nào ĐỒNG Ý VỚI VIỆC CA IN GIẾT EM MÌNH VÀ TUYÊN BỐ AI 
	GIẾT CA IN THÌ PHẢI CHỊU BẢY LẦN HÌNH PHẠT.</p>
	<p>
	...
	*Thượng đế không thể nào PHÂN BIỆT ĐỐI XỬ, bởi vì tất cả là con cái ngài; 
	huống hồ TIÊU DIỆT BẢY DÂN TỘC CHỈ ĐỂ CHO DO THÁI TỒN TẠI.</p>
	<p>
	*Thượng đế không thể nào có Tiên tri sai lầm, thí dụ : phán là tuổi con 
	...
	tiên tri, chứ đừng nói là Chúa !</p>
	<p>
	*Thượng đế không thể nào chọn Áp ra ham, nguời lấy em ruột mình, làm Tổ phụ 
	...
	giết để tế Thượng đế ! (Xin đừng dùng chữ "THỬ"; vì Chúa là đấng TOÀN TRI.)</p>
	<p>
	*Thượng đế không thể nào chấp nhận Na cô LẤY HAI ĐỨA CHÁU RUỘT (stk 12:29)</p>
	<p>
	...
	*Thượng đế không thể nào đồng mưu với mẹ con Gia cốp để hại Ê sau là anh 
	ruột của ông ấy. Mẹ cũng hại con truởng mình!</p>
	<p>
	...
	trên, là cái luân của Do thái; do Chúa Do thái dạy vẽ; xin hãy đọc :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	ngươi , vì là cốt nhục của mẹ ngươi ....(Lê vi ký 18:6-18). </p>
	<p>
	...
	Thần Chiến tranh và là Thánh tổ đạo Chúa Do thái đã lấy Cô ruột mình !!!</p>
	<p>
	...
	đúng ? Đến như Sa lô môn có BẢY TRĂM MỤ, Chúa vẫn cho ngài là tốt nhất !!!</p>
	<p>
	...
	thông...Tất cả là HÀNH ĐỘNG CỦA THẦN RẮN.</p>
	<p>
	Vì vậy, xin phép để "báo cáo" rằng :</p>
	<p><b>
	...
	CHƯA TỪNG NGHE THẤY !!!</b></p>
	<p>
	"THE LORD OF HOST- THE GOD OF ISRAEL"</p>
	<p>
	(Chỉ là Thần Chiến tranh và là đức Chúa trời của riêng dân Do thái)</p>
	<p>
	...
	đọc lại vài câu cho thấm tình cùng Thượng đế Do thái :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	chưa hề kết bạn cùng nguời nam. </p>
	<p>
	<font face="Symbol">·</font> 
	Phải đuổi giết hết thảy dân của xứ khỏi truớc mặt các ngươi . Phá hủy hết 
	thảy hình tuợng chạm, và hình đúc của chúng nó. </p>
	<p>
	<font face="Symbol">·</font> 
	...
	<p>
	<font face="Symbol">·</font> 
	Phàm vật gì có hơi thở thì diệt đi. </p>
	<p>
	<font face="Symbol">·</font> 
	Bất kỳ ai không khứng vâng theo thầy tế lễ đều phải chết. </p>
	<p>
	<font face="Symbol">·</font> 
	...
	<p>
	<font face="Symbol">·</font> 
	Kẻ nào tế thần khác hơn một mình đức Giê hô va, sẽ bị diệt. </p>
	<p>
	<font face="Symbol">·</font> 
	Phải giết những kẻ nào thuộc về bọn cúng thờ Ba anh Phê ô. </p>
	<p>
	<font face="Symbol">·</font> 
	...
	***BẤT KỲ AI KHÔNG KHỨNG VÂNG THEO THẦY TẾ LỄ ĐỀU PHẢI CHẾT***</p>
	...
	quên mình phục sự là :</p>
	<p>
	ĐỨC GIÊ HÔ VA LÀ CƠ NGHIỆP CỦA HỌ</p>
	<p>
	Do đó :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	(Phục truyền luật lệ ký 17:3-5). </p>
	<p>
	...
	bán mạng mà làm !!! Còn "con chiên" thì muôn đời "vẫn thú"!!!</p>
	<p class="center">
	***050814***</p>
	
	<p class="CHUONG">
	<a name="32">CHƯƠNG</a> 32 :</p>
	<p class="TuaChuong">
	ĐỂ CHO CHÚNG NÓ TIN RẰNG</p>
	...
	THẦN RẮN như thế nào; VAI TRÒ, ĐỊA VỊ của Rắn ra sao.</p>
	<p>
	...
	chủ quan của mình khi trình bày.</p>
	<p>
	Chúng ta hãy bắt đầu bằng sự xuất hiện của Rắn : </p>
	<p>
	<font face="Symbol">·</font> 
	...
	TRỜI, BIẾT ĐIỀU THIỆN ĐIỀU ÁC.(stk 3:1-5) </p>
	<p>
	<font color="#606060">(Now the serpent was more subtil than any beast of the field which the Lord 
	...
	TỰ. Nghĩa là "THUỢNG ĐẾ LÀ HÒN ĐÁ CỦA TÔI", như Đa vít đã nói !!!</p>
	<p>
	Đọc lại câu :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	là MÊ TÍN). Vậy để cùng cảm thông với nhau, xin hãy đọc lại câu :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	TRUỒNG VÀ ĐẦN ĐỘN; tôi chỉ "Y KINH". </p>
	<p>
	...
	đừng theo. Còn chính ông; và chỉ riêng ông độc quyền THỜ THẦN RẮN mà thôi !</p>
	<p>
	Hãy cùng tôi truy cứu cho ra lẽ hư thật của THẦN RẮN :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	Chúa trời (Xuất Ê díp tô ký 3:2-5) </p>
	<p>
	...
	trên mặt đất vậy. (xedtk 4: 8-9) </p>
	<p>
	...
	đại họa. Xin quý vị đọc kỹ những phép lạ của Ngài thì rõ. </p>
	<p>
	Thấy như thế chưa đủ rõ, 
	ông đa biến nước thành MÁU; một màu, một vị, rất hấp dẫn với LOÀI RẮN !!!</p>
	<p>
	Nếu vị nào chưa tin, xin hãy tự làm như sau :</p>
	<p>
	...
	ngài không ??? Xin tiến sỹ Huy cho biết với !</p>
	<p>
	Trong Xuất Ê dí tô ký, CHƯƠNG 4, từ câu 24 đến 26 là một đoạn văn rất khó 
	hiểu. Tôi xin trích ra đây hai cách dịch để thấy sự mù mờ trong đó:</p>
	<p>
	<font face="Symbol">·</font> 
	...
	phép cắt bì (Thánh kinh hội Mỹ quốc Nữu uớc). </p>
	<p>
	<font face="Symbol">·</font> 
	...
	phép cắt bì (Linh mục Pascal Nguyễn ngọc Tỉnh) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	circumcision (the Holy Bible of Holman Bible publisher 1998). </p>
	<p>
	...
	Môi se; và đây, chỉ là một đề nghị :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	Chúa mới tha ông. Nếu ông không hứa, thì chắc đa chết rồi.</p>
	<p>
	...
	<p>
	<font face="Symbol">·</font> 
	Lỗ mủi ngài thở hơi ra, nước bèn dồn lại, </p>
	<p>
	Lượn sóng đổ như dựng một bờ đê.</p>
	<p>
	Vực sâu đọng lại nơi rốn biển (xedtk-15:8)</p>
	<p>
	<font face="Symbol">·</font> 
	Ngài đã thở hơi ra, </p>
	<p>
	Biển vùi lấp quân nghịch lại</p>
	<p>
	Họ bị chìm như cục chì,</p>
	<p>
	Nơi đáy nước sâu (xdtk-15:10) </p>
	<p>
	<font face="Symbol">·</font> 
	Ngài đưa tay hữu ra, </p>
	<p>
	Đất đã NUỐT chúng nó (xedtk-15:12)</p>
	<p>
	...
	Các vị sau, thì lại dùng chữ DEVOUR, chính xác hơn !</p>
	<p>
	<font face="Symbol">·</font> 
	...
	người thụt tay xuống, dân A ma léc lại thắng hơn (xedtk-17:11) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	xuống". Tuy nhiên, với RẮN ĐỘC; đặc biệt, với THẦN RẮN, thì hãy cẩn thận !!!</p>
	<p>
	<font face="Symbol">·</font> 
	...
	KỴ TÀ; Ngài thật là một ĐỨC CHÚA TRỜI KỴ TÀ vậy. (xedtk-34: 10-14) </p>
	<p>
	...
	TÀ". Tôi có nói sơ qua về vấn đề này. Nay xin thêm chút đỉnh cho vui.</p>
	<p>
	...
	những "thực tế" sau này.</p>
	<p class="center">
	***050903***</p>
	
	<p class="CHUONG">
	<a name="33">CHƯƠNG</a> 33: </p>
	<p class="TuaChuong">
	DÂNG TAY CHO CHÚA BA NGÀN</p>
	...
	tôn lên là KINH !!! Đúng là ĐỘC NHƯ LOÀI RẮN !</p>
	<p>
	Xin hãy "cẩn thận" đọc BÁO PHỤC HÌNH để thấy "ánh sáng tâm linh" của Rắn:</p>
	<p>
	<font face="Symbol">·</font> 
	...
	TA SẼ LẬP MỘT CHỖ ĐẶNG KẺ GIẾT NGUỜI ẨN THÂN (xedtk-21:12-13) </p>
	<p>
	...
	Môi se bèn LẤY HUYẾT RUỚI TRÊN MÌNH DÂN SỰ mà nói rằng :ĐÂY LÀ </p>
	<p>
	...
	đã trở thành ẨM HUYẾT QUỶ VƯƠNG!</p>
	<p>
	...
	ngươi trên núi vậy (xedtk-27:1-8) </p>
	<p>
	...
	Nếu không phải là "dấu hiệu của đầu RẮN ??? Xin đọc thêm </p>
	<p>
	<font face="Symbol">·</font> 
	...
	của lễ dùng lửa dâng lên cho đức Giê hô vậy (xedtk-29:10-18). </p>
	<p>
	...
	MÌNH, HẦU CHO CÁC ngươi ĐƯỢC ƠN PHUỚC (xedtk-32:28-29). </p>
	<p>
	...
	tộc, quốc gia, đâu có nhằm nhò gì chứ ?</p>
	<p>
	Đọc trong Lê vi ký, quý vị sẽ thấy rất rõ những Lễ nghi của Thần Rắn. Ở đây, 
	tôi chỉ trích ra vài câu tuợng trưng thôi:</p>
	<p>
	<font face="Symbol">·</font> 
	...
	lấp lại và chúng nó bị DIỆT khỏi hội chúng (16:32-33). </p>
	<p>
	...
	Hô ro". Đúng là ĐỘC NHƯ RẮN !!!</p>
	<p>
	Nếu vị nào cho rằng, tôi bôi bác, thì xin hãy đọc đoạn này :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	nghiệm; chính là cái MIỆNG THẦN RẮN LỬA há ra, NHƯ tôi đã trình bày.</p>
	<p>
	Hãy đọc lại những câu :</p>
	<p>
	<font face="Symbol">·</font> 
	Nguời ngoại đạo đến gần SẼ BỊ XỬ TỬ (dsk-3:10) </p>
	<p>
	<font face="Symbol">·</font> 
	Nguời ngoại đạo đến gần SẼ BỊ XỬ TỬ (dsk-3:38) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	ĐẦU RA. Mà như ngài đa nói :"AI THẤY TA MÀ CÒN SỐNG ? ".</p>
	<p>
	Đúng vậy, đưa mình vào MIỆNG RẮN ĐỘC, thì làm sao khỏi chết !!! Hai con trai 
	của A rôn cũng đã chết trong trường hợp này !!!</p>
	<p>
	...
	<p class="CHUONG">
	<a name="34">CHƯƠNG</a> 34: </p>
	<p class="TuaChuong">
	GÂY THẢM HỌA HÓA ĐẠI THẦN</p>
	<p>
	Bây giờ, chúng ta hãy tóm luợc những kết quả hành động của ông Giáo chủ Môi 
	se, và cũng là của Giê hô va đức Chúa trời :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	nguời làm y như vậy..(xedtk-8:16-17) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	hủy hoại (xedtk-834) </p>
	<p>
	<font face="Symbol">·</font> 
	Vừa đến mai, đức Giê hô va làm sự đó, hết thảy súc vật nguời Ê díp tô đều 
	chết; Nhưng của dân Y sơ ra ên chẳng chết một con (xedtk-8:6) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	*****&nbsp; 
	...
	tô, vì chẳng một nhà nào mà không có nguời chết (xedtk-12:29-30) </p>
	<p>
	*****&nbsp; 
	...
	*****&nbsp; 
	...
	(không ghi giết bao nhiêu). (xedtk-18:13) </p>
	<p>
	*****&nbsp; 
	...
	*****&nbsp; 
	...
	dân sự, hành dân sự một tai vạ rất nặng (dân số ký :11:33) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	*****  
	...
	tai vạ này, trừ ra những kẻ bị chết bởi cớ Cô rê (dsk-16:44-49) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	*****  
	...
	sơ ra ên chết rất nhiều (dsk-21:6) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	*** Xin nhớ cho rằng, "chỉ vì lấy ngoại đạo”, mà Chúa trời giết HƠN HAI MƯƠI 
	...
	sao nguời khác lấy, thì bị giết tập thể ? </p>
	<p>
	...
	***** 
	...
	Tướng cướp cướp của bọn cướp !!!</p>
	<p>
	<font face="Symbol">·</font> 
	...
	Chúa Vạn Năng, Đầy Yêu Thương như Thần Rắn !!!</p>
	<p>
	<font face="Symbol">·</font> 
	...
	Chúng ta hãy đọc một vài lời giảng này để tạm hiểu về ngài:</p>
	<p>
	<font face="Symbol">·</font> 
	...
	LÀM MỘT DÂN THUỘC RIÊNG NGÀI (ptllk-7:1-6) </p>
	<p>
	...
	TẠO VẬT CHỦ, THIÊNG LIÊNG...BAO GỒM TRONG MỘT CHỮ DIỆT !!! </p>
	<p>
	Đến đây, chúng ta có thể trả lời cho Lê anh Huy về:</p>
	<p>
	"Trên mặt phẳng tâm linh có một câu hỏi cơ bản vẫn chưa đuợc trả lời: Từ đâu 
	sinh ra hình ảnh một con vật kinh sợ gớm ghiếc đó ?"</p>
	<p>
	...
	rồi, cần chi dài dòng mỏi miệng.</p>
	<p>
	...
	Thánh kinh". </p>
	<p>
	Sau khi học xong, con xin viết lại:</p>
	<p>
	...
	hòng "lập lờ đánh lận con đen" !!!</p>
	<p>
	...
	trong hành trình đến Vùng đất Hứa :</p>
	<p>
	<font face="Symbol">·</font> 
	Chúng lấy thành, đưa gươm qua diệt mọi vật ở trong thành, nào nam phụ, lão, 
	ấu, cho đến bò, chiên và lừa (gs 6:20-21) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	***Mỗi lần TIẾN CÁO quan trọng như thế, là mỗi lần thiên hạ chịu mang những 
	...
	nào bảo diệt chủng, phá thành, đi ăn cuớp ??? Chỉ có loài RẮN ĐỘC thôi !</p>
	<p>
	...
	SAU BỨC MÀN THUỢNG ĐẾ, NÓ NGÓC ĐẦU RA TẠI NẮP THI ÂN !!!</p>
	<p>
	*****  
	...
	đời đời y NHƯ hãy còn đến ngày nay (gs-8:22-28) </p>
	<p>
	...
	giảng, Thần học gia</p>
	<p class="center">
	***050909***</p>
	
	<p class="CHUONG">
	<a name="35">CHƯƠNG</a> 35 : </p>
	<p class="TuaChuong">
	MÁU TƯƠI MỠ CHÓP MỠ CHÀI</p>
	...
	rành mạch, thì xin đọc thẳng vào Kinh, thì hay hơn nhiều.</p>
	<p>
	<font face="Symbol">·</font> 
	Nhưng Môi se tâu rằng: Làm như vậy chẳng tiện, vì các của lễ mà chúng tôi sẽ 
	tế Giê hô va đức Chúa trời chúng tôi, là MỘT ĐIỀU GỚM GHÊ CHO NGUỜI Ê DÍP 
	TÔ. Nếu chúng tôi dâng của lễ gớm ghê truớc mặt nguời Ê díp tô, họ há chẳng 
	liệng đá chúng tôi chăng ? (xedtk-8:26) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	qua, chẳng có tai nạn hủy diệt các ngươi . (xedtk-12:1-13) </p>
	<p>
	...
	lên hai cột nhà, và lên mày cửa (?). Như vậy, chỗ nào có MÁU là "phe ta" !!!</p>
	<p>
	<font face="Symbol">·</font> 
	...
	ta sẽ chỉ cho ngươi . (xedtk-25:1-9) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	mạng lệnh về dân Y sơ ra ên. (xedtk-25:17-22) </p>
	<p>
	<font face="Symbol">·</font> 
	...
	Tộc truởng và hàng vạn dân lành vô tội khi họ than thở với ông !</p>
	<p>
	...
	con nguời vào con đường đen tối nữa : </p>
	<p>
	CON ĐUỜNG LỢI DỤNG THƯỢNG ĐẾ !!!</p>
	<p>
	Bây giờ, chúng ta bước qua lãnh vực tế lễ :</p>
	<p>
	<font face="Symbol">·</font> 
	...
	thờ...có mùi thơm cho đức Giê hô va. (Lê vi ký 1:1-17) </p>
	<p>
	Xin hãy tự đọc. Tôi càng trích ra, thấy càng gớm ghiếc. Chắc quý vị đã thấy 
	biết ai ở trên bàn thờ ấy rồi !</p>
	<p>
	<font face="Symbol">·</font> 
	...
	ngươi CHẲNG NÊN ĂN MỠ HAY LÀ HUYẾT. (lvk-3:1-17) </p>
	<p>
	...
	phải lắm chứ; tốt lắm chứ; đâu phải hoang đuờng như bạn tuởng ?</p>
	<p>
	...
	vua Pha ra ôn ? </p>
	<p>
	Xin những nhà thông thái chỉ điểm dùm cho !!!</p>
	<p>
	...
	Chú Chệt biểu diễn trong một tiệm ăn.</p>
	<p>
	...
	con, năm này qua tháng nọ, lại còn bảo dâng của lễ đời đời !!!</p>
	<p>
	...
	nhân gian và chúng sinh vạn loại !!! </p>
	<p>
	KHÔNG-KHÔNG-KHÔNG-DỨT KHOÁT LÀ KHÔNG</p>
	<p>
	Không thể có một Thượng đế, Giê hô va, đức Chúa trời, ông Trời nào như thế 
	cả. Mà chính là LOÀI RẮN ĐỘC tiếm xưng !</p>
	<p>
	Đến đây, tôi có thể trả lời cho Lê anh Huy về đoạn kết luận của ông trong 
	bài Truyền thuyết Con Rồng Cháu Tiên: </p>
	<p>
	Huy viết : "<i>truyền thuyết "con rồng cháu tiên" là một sự lừa dối của Satan, 
	...
	ngài chọn làm cơ nghiệp mình có phuớc thay</i>".</p>
	<p>
	Xin thưa tiến sỹ,</p>
	<p>
	...
	trích dẫn từ trước tới giờ. Nó kêu gọi :</p>
	<p>
	...
	cần phải dài dòng thêm nữa, mà có thể trả lời dứt khóat với tiến sỹ rằng :</p>
	<p>
	...
	KỴ ?</p>
	<p>
	Ô hô ! Lê anh Huy viết : "<i>dân tộc nào được ngài chọn làm cơ nghiệp có phước 
	thay</i>" ! </p>
	<p>
	...
	CÓ HOẠ cho Israel, kể từ ngài nhận họ đến nay ???</p>
	<p>
	...
	bày tay Thượng đế !!! Thế thì, CÓ PHƯỚC THAY CHỖ NÀO ???</p>
	<p>
	...
	BÂY GIỜ "DÂN CHÚA CHỌN" đã đi về đâu ?</p>
	<p>
	...
	TAY ngươi "; vì như thế là BUỘC TỘI THUỢNG ĐẾ !</p>
	<p>
	Vâng theo lời dạy của thầy Huy :"<i>Nhận diện đuợc Satan và công việc nó, chúng 
	...
	hãnh diện mang lấy hình hài của nguời mà lại đi nhận một con bò sát là cha</i>".</p>
	<p>
	...
	SỰ VẬT; nên dứt khóat KHÔNG GIỐNG THẦN RẮN DO THÁI.</p>
	<p>
	...
	khi nghe CON RẮN lại chê CON RỒNG !</p>
	<p>
	...
	trong lồng THẦN THƯỢNG ĐẾ !!!</p>
	<p>
	CHUI CHOA, BÒ SÁT TỰ CHÊ BÒ SÁT, VÌ CHỈ MUỐN ĐỘC TÔN BÒ SÁT !!!</p>
	<p class="center">
	***050911*** </p>
