...
<div align="center" style="position: relative; left: 0; top: 0">
 ...
 <table id="0" border="1" cellpadding="0" cellspacing="0" width="700" bordercolor="#FF9966" bordercolorlight="#FFFFCC" bordercolordark="#606060"> <tbody><tr><td> 

	
<table id="0" border="0" cellpadding="0" cellspacing="0" width="700" bgcolor="#FDFDFD"> <tbody><tr><td> 
		<br>
		
		<p class="Tuaduoi">
		lịch sử tồn tại trong lòng dân </p>
...
<tr> <td width="100%"> 
		...
		<div style="padding-left: 50px; padding-right: 50px">
			...
			<a href="https://www.tuoitre.com.vn/Tianyon/Index.aspx?ArticleID=235942&amp;ChannelID=87">
			</a><p class="MUC"><a href="https://www.tuoitre.com.vn/Tianyon/Index.aspx?ArticleID=235942&amp;ChannelID=87">Lại bàn về học sử</a></p>
			
			<p>TT - "<i><font size="3">Họa phúc hữu môi phi nhất nhật</font></i>"! (Nguyễn Trãi). Nếu xem tình 
		...
		môn lịch sử trong nhà trường, nhất là ở bậc tiểu học và trung học cơ sở.</p>
			...
			<object id="winMediaPlayerID" type="application/x-oleobject" height="45" standby="Loading Microsoft Windows Media Player components..." width="250" name="winMediaPlayer" classid="CLSID:6BF52A52-394A-11D3-B153-00C04F79FAA6" codebase="https://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=6,4,5,715">
				<param name="URL" value="mms://222.255.121.179/Stream/audio/2007/thang12/27-12/Lai_ban_ve_hoc_su.mp3">
				...
				<embed type="application/x-mplayer2" id="wmpEmbed" pluginspage="https://www.microsoft.com/Windows/MediaPlayer/" src="https://pub-756b239a5ae84d4c8c8ff709f375d430.r2.dev/VANHOC/mms://222.255.121.179/Stream/audio/2007/thang12/27-12/Lai_ban_ve_hoc_su.mp3" name="MediaPlayerTV" height="45" width="250" autosize="1" autostart="0" clicktoplay="1" displaysize="1" enablecontextmenu="0" enablefullscreencontrols="1" enabletracker="1" mute="0" playcount="999" showcontrols="1" showaudiocontrols="1" showdisplay="0" showgotobar="0" showpositioncontrols="1" showstatusbar="1" showtracker="1"> 
</object>&nbsp;
			
			<p>Lịch sử dân tộc "đổi thay đã hơn bốn nghìn niên" với bao thăng trầm 
		...
		dạy và người học. </p>
			<p>Chúng ta dạy lịch sử như vốn có hay dạy một thứ lịch sử đã được quan 
		...
		chết"...</p>
			<p>Lịch sử dân tộc đâu chỉ là sợi dây xâu chuỗi các sự kiện và vấn đề mà 
		còn là lịch sử "địa linh nhân kiệt" - lịch sử của những vùng đất thiêng 
		liêng, của những tâm hồn cao khiết. </p>
			<p>Thay vì dạy về các cuộc khủng hoảng kinh tế thế giới, chủ nghĩa phân 
		...
		cũng là giảng dạy về đạo đức và thiên lương.</p>
			<p>Lịch sử dân tộc qua sách giáo khoa hiện nay phần lớn đều khô khan, 
		...
		võ bị và bang giao, Nhà Nguyễn và công cuộc mở mang bờ cõi... </p>
			<p>Lịch sử không phải là truyện cổ tích nhưng sách lịch sử nhất thiết 
		...
		cảm, xúc cảm của trái tim.</p>
			<p>Và để nhớ lịch sử dân tộc đâu chỉ có học, có thi mà còn có chơi, có 
		...
		học nhớ quốc sử hồn nhiên và lâu bền.</p>
			<p>Tiếc rằng những cuốn giáo khoa lịch sử như vậy chỉ còn là hoài niệm 
		và mong ước của rất nhiều người!</p>
			
			
			<hr>
			
			<p class="MUC">Sách giáo khoa phải giúp lịch sử tồn tại trong lòng dân 
			</p>
			
			<p>TTO - Tôi vừa đọc xong bài "Lại 
			...
			<p>Tôi đã từng xem qua các sách 
								...
								yêu mến học Sử. </p>
			<p>Không chỉ là bàn luận suông từ 
								...
								đáng công sức đầu tư của thầy cô). </p>
			<p>Sau các tiết học đó, đặt câu 
								...
								sách giáo khoa môn Sử. </p>
			<p>Cuối cùng, cám ơn tác giả 
								...
								đối với chúng tôi. </p>
			<p>Nếu có những cuốn sách như vậy 
								...
								cùng thế giới. </p>
			<p style="text-align: right"><font size="2">LÝ MINH TIÊN (GV Trường ĐH Sư 
								Phạm TP HCM)</font></p>
			
			<p>Tôi tán thành ý kiến của nhà 
								...
								về bà Cù Thị Hậu... ở gần cuối sách. </p>
			<p>Tôi nghĩ, Trường ĐH KHXH&amp;NV là 
								...
								em (học sinh) của chúng ta nữa.&nbsp; </p>
			<p>Hơn thế nữa, viết sử phải cẩn 
								...
								wiki như Thư viện Khoa học&nbsp; (<a onclick="return onLinkClick(this)" location="yes" statusbar="yes" menubar="yes" scrollbars="yes" titlebar="yes" toolbar="yes" resizable="yes" width="800" height="600" href="https://thuvienkhoahoc.com/">https://thuvienkhoahoc.com/</a>). </p>
			<p>Về kinh phí, có thể huy động 
								...
								người!".</p>
			<p style="text-align: right"><font size="2">TRẦN TRỌNG CHÂU</font></p>
			
			<p>Tôi năm nay 45 tuổi rồi, thế mà 
								...
								Số học; Đo Lường; Khoa học...). ]</p>
			<p>Tôi nhớ như in những bài học Sử 
								...
								nước. </p>
			<p>Những cái tựa nghe cũng rất hay 
								...
								nhàng qua những bài học như thế. </p>
			<p>Tiếc thay các em học sinh ngày 
								...
								lắm thay!</p>
			<p style="text-align: right"><font size="2">TRẦN HỮU NGỌC</font></p>
			
			<p>
			<a href="https://www.tuoitre.com.vn/Tianyon/Index.aspx?ArticleID=235942&amp;ChannelID=87">Bài của&nbsp;tác giả&nbsp;Nguyễn Hà</a> rất đầy đủ và toàn 
								...
								có tình nghĩa, luân thường đạo đức. </p>
			<p>Ngoài những phương pháp dùng để 
								...
								cũng rất hiệu nghiệm. </p>
			<p>Nhưng nhớ lại, từ&nbsp;khi lớn lên, 
								...
								Quang Trung...</p>
			<p style="text-align: right" class="TacgiaR"><font size="2">Tran L Hong</font></p></div>
