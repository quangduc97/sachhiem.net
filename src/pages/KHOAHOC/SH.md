...
<table id="0" border="1" cellpadding="0" cellspacing="0" width="650" topmargin="10" bordercolor="#FF9966" bgcolor="#F2F4F4" bordercolorlight="#FFFFCC" bordercolordark="#606060"> 
...
<tr> <td width="100%"> 
	<div style="padding-left: 40px; padding-right: 40px">
		...
		<p>It's only fitting to recognize the accomplishments of a great biologist. 
		...
		demonstrated that germs cause diseases. </p>
		<p>Today biologists are exploring 
		...
		of fun. I'm not complaining." </p>
		<p>Darwin developed his theory by gathering 
		...
		Origin of Species for biologists to determine that the answer was DNA. </p>
		<p>DNA is like a genetic cookbook, using four molecular "letters" to spell 
		...
		about how life evolved. </p>
		<p>Time and again, biologists are finding that 
		...
		biologist at Yale University. </p>
		<p>Darwin proposed that natural selection 
		...
		changes that boost reproductive success. </p>
		<p>As populations adapt to their surroundings, they can gradually evolve 
		...
		into the problem, despite the title of his magnum opus." </p>
		<p>Biologists have 
		...
		mushrooms than to sunflowers. </p>
		<p>It's been 1.5 billion years or more since 
		...
		track. </p>
		<p>Biologists are a long way from understanding the entire genome, 
		...
		through a series of intermediate forms. </p>
		<p>Paleontologists can track some 
		...
		arm or a brain or a tongue. </p>
		<p>These networks are so intricate that they probably put some limits on 
		...
		to recycle old genes.</p>
		<p>Growing hair, for example, is a trait that evolved 
		...
		borrowed to help build hair. </p>
		<p>Darwin had no way of knowing this, since he 
		...
		pathogen is related to. </p>
		<p>But there's more to the history of life than the 
		...
		the tree of life are being grafted together. </p>
		<p>Biologists have documented 
		...
		new combinations. </p>
		<p>In the mid-1900s, biologists succeeded in merging the newest 
		...
		produce new traits. </p>
		<p>Some researchers argue that many patterns of 
		...
		see things coalescing for at least a decade or more." </p>
		<p>Darwin predicted 
		...
		saw his work not as the end of biology but as a beginning. </p>
		<p>Putting 
		Evolution to The Test. How does Darwin hold up? </p>
		<p>Darwin's microscope. His 
		research, given the technology, was robust </p>
		<p>[This article contains a 
		table. Please see hardcopy of magazine or PDF.] </p>
		<p>DARWIN TODAY Species share a common ancestry, like branches on a tree 
		...
		for building old organs have been "borrowed" to help build new ones.</p>
		<p>&nbsp;Zimmer is the author of the forthcoming book The Tangled Bank: An 
		Introduction to Evolution </p>
