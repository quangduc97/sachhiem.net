...
<tbody><tr><td>	
		...
		<p class="Tuaduoi">French Missionary Expansion in Colonial Upper Tonkin 
</p>
...
<div style="padding-left: 50px; padding-right: 50px">
	<table border="0" cellpadding="0" width="87%">
		<tbody><tr>
			<td valign="top"></td>
			<td valign="top" width="239"> 05 tháng 8, 2009 	</td></tr></tbody></table>
	<p><i>Bài báo này nghiên cứu những trường hợp mở rộng công cuộc truyền giáo ở 
	...
	<p>Jean Michaud cộng tác biên khảo ở Đại Học Montréal, Canada. </p>
	<p>Địa chỉ e-mail liên lạc là jean.michaud@umontreal.ca</p>
	
	<p class="TuaDoLeft"><b>	Công cuộc truyền giáo và kế hoạch xâm chiếm 
	Bắc Kỳ</b></p>
	
	
	<p>Nhiều tác giả đã nhận định rằng sự bành trướng thuộc 
	...
	biệt lệ và nghiên cứu mới đây như <i>Đồng bào Dân tộc của Cao Nguyên Trung 
	Phần Việt Nam</i> của Oscar Salemink đã khẳng định thêm về quan điểm này.<sup>9</sup></p>
	...
	thập niên đầu tiên có sự hiện diện của người Pháp.<sup>10 </sup>Một nhân 
	...
	trướng sự cai trị của người Pháp tại Việt Nam.</p>
	...
	đầu năm 1894.<sup>11</sup> Để tránh sự lập lại không cần thiết ở đây, chúng 
	...
	duy trì địa vị đặc quyền của họ - ủng hộ phong trào kháng chiến. </p>
	
	<p>Để 
	đáp lại, đội quân xâm lược Pháp tung ra <i>sứ mệnh bình định (mission de 
	pacification)</i>, một chiến dịch không hề khoan nhượng được kéo dài trọn 
	...
	giữ chức vị từ năm 1891–1894. </p>
	...
	sinh mạng và tiền bạc mà nó phải gánh chịu này.”<sup>12</sup> Sự thật là 
	...
	lối của những người lãnh đạo hội truyền giáo do Paul Puginier lãnh đạo.</p>
	...
	xưng tội. <sup>13 </sup>Lực lượng võ trang bị làm suy yếu dần một cách đáng 
	kể do người Pháp tranh thủ được hàng ngàn người Công giáo mới được cải đạo 
	hàng năm ở vùng châu thổ và những vùng phụ cận chung quanh.<sup> </sup>
	</p>
	...
	trong cuộc gây biến (<i>coup de force)</i> ở Hà Nội năm 1873 và đóng một vai 
	...
	từ ý tưởng này.<sup>14</sup> Sự tác động lâu dài ảnh hưởng của ông ta lên 
	...
	mà sau đó thâm nhập vào Bắc Kỳ và cao nguyên Bắc Kỳ. </p>
	
	
	<p><b>
	Các Ghi Chép của Puginier</b></p>
	...
	gửi “Các ghi chú và thông tin tình báo” (‘<i>Notes et renseignements</i>’) 
	nổi tiếng đến chính quyền thuộc địa, đôi khi là gửi hàng tuần.<sup>15 </sup>Tuy 
	...
	Cộng hòa Thứ Ba non trẻ (1870–1940). </p>
	...
	Cao nguyên Bắc Kỳ, chúng đáng được quan tâm.<sup>16</sup></p>
	...
	liệt các quan lại địa phương và giới sĩ phu hay các <i>nhà nho, </i>ông ta 
	...
	nhu nhược để đạt được thành công.<sup>18</sup> Y như tâm địa Puginier chẳng 
	...
	303 con chiên (303,000 F)’.<sup>19</sup> Cái giá trị tương xứng một mạng 
	...
	sống theo phúc âm của ông ta.</p>
	...
	được nói đến và cứ được lập đi lập lại? Cần phải làm gì ?” <sup>20</sup></p>
	...
	đề của xứ Bắc Kỳ” (Notes sur la question du Tonkin) được viết năm 1884.</p>
	...
	dầu lanh v.v.. Chưa tính đến các mỏ than đá, vàng và thiết. </i></p>
	...
	chưa từng biết đến.<sup>21</sup></i></p>
	...
	sẽ hỗ trợ từng bước thâu tóm toàn bộ dân chúng cho sự nghiệp của nước Pháp”.<sup>22</sup></p>
	<p>
	...
	đội Pháp’.<sup>23</sup> Tuy nhiên, câu trả lời thứ ba là của chính 
	...
	Ấn xưa kia (<i>Compagnie des Indes</i>), và xây dựng một nông trang thí điểm 
	...
	Pháp vì thế cũng sẽ bị suy yếu dần một cách không thể khác được.</p>
	...
	“Công giáo toàn tòng hóa quốc gia này” (<i>christianiser le pays</i>). Ông 
	...
	nhà truyền giáo sẽ là nòng cốt trong chiến lược này:</p>
	...
	giáo dân Công giáo, nói một cách khác, là những người Pháp”.<sup>24</sup></p>
	...
	quan tâm việc giữ lòng trung thành đối với nước Pháp”.</p>
	...
	quí và, khi cần thiết, thưởng tiền bạc cho họ..<sup>25</sup></i></p>
	...
	ND) đối với sự 
	cai trị thuộc địa đơn giản đâu chỉ là ngẫu nhiên? <i><sup>26 </sup></i>
	...
	khai” (<i>demisauvages), là </i>những người chia sẻ mối tương quan quyền lực 
	...
	của dân tộc miền cao.<i><sup>27</sup></i> Ông ta hiểu cách các quan lại của 
	...
	thổ cho những người kế nhiệm mình.</p>
	...
	cách tốt nhất – và, cũng vì lẽ ấy, mà sinh ra mấy cái đề tài ‘dân tộc học’.</p>
	...
	xứ Bắc Kỳ nhờ vào những Ghi chép của Giám mục Puginier.<sup>28</sup></p>
	...
	Puginier là người “đại diện có thẩm quyền cao nhất của nước Pháp ở Bắc Kỳ.”<sup>29</sup> 
	...
	trong việc chiếm đóng Bắc Kỳ của người Pháp - được phong tước <i>Hiệp sĩ</i> 
	, và sau đó là <i>Người được thưởng huy chương</i> Bắc đẩu bội tinh.<sup>30</sup></p>
	...
	đầu đã có thể tiên đoán hay đưa ra lời kêu gọi.</p>
	<p class="TacgiaL">Nguyễn Trí Cảm chuyển ngữ</p>
	<p>TP.HCM, tháng 7 năm 2009 – </p>
	
	
	<p class="TuaDenLeft">Chú 
	thích của người dịch :</p>
	<p>[*]
	MEP : <i>
	Société des Missions Etrangères de 
	Paris</i> –Hội Thừa Sai Paris </p>
	<p>
	- Đông 
	Pháp: Đông Dương thuộc Pháp</p>
	<p>
	- Chân 
	phước: chức danh của người được xem là rất thánh thiện nhưng chưa được phong 
	thánh của giáo hội Công giáo La Mã.</p>
	...
	<div style="border: 1px solid #606060; padding: 8px; background-color: #F0F0F6">
		[Source:<a style="color: blue; text-decoration: underline; text-underline: single" href="https://journals.cambridge.org/download.php?file=%2FSEA%2FSEA35_02%2FS0022463404000153a.pdf&amp;code=ecfd9921233d9e116ca4bcf617ba24df">https://journals.cambridge.org/download.php?file=%2FSEA%2FSEA35_02%2FS0022463404000153a.pdf&amp;code=ecfd9921233d9e116ca4bcf617ba24df</a> 
	]
	<p><i>
	Journal of Southeast Asian Studies, 35 (2), pp 287–310 June 2004</i>. 
	Printed in the United Kingdom.</p>
	<p>© 
	2004 The National University of Singapore DOI: 10.1017/S0022463404000153287</p>
	<p class="TuaDenLeft">
	French Missionary Expansion in Colonial Upper Tonkin </p>
	<p class="TacgiaL">Jean 
	Michaud</p>
	...
	before its decline towards the final exit of the French in the late 1940s.</i></p>
	
	<p>Jean 
	Michaud is an Associate Researcher at the Université de Montréal in 
	Montréal, Canada. His e-mail contact is
	<a style="color: blue; text-decoration: underline; text-underline: single" href="mailto:jean.michaud@umontreal.ca">
	jean.michaud@umontreal.ca</a> </p>
	...
	extended to the anonymous <i>JSEAS </i>referees who contributed very helpful 
	remarks to the first draft of this article, as well as to Oscar Salemink for 
	stimulating conversations relating to colonial ethnography and Indochina.</p>
	
	
	<p><b>
	Missions and the colonial project in Tonkin</b></p>
	...
	no exception to this rule and recent research such as Oscar Salemink’s <i>
	The ethnography of Vietnam’s Central Highlanders </i>has further confirmed 
	this opinion.<sup>9</sup></p>
	...
	missions in Tonkin during the first decades of the French presence.<sup>10</sup> 
	...
	saw. This was Paul-François Puginier, Bishop <i>in partibus </i>of 
	Mauricastre, and Vicar Apostolic of West Tonkin and of Hanoi from 1868–92, a 
	key figure in the establishment and expansion of French rule in Vietnam.</p>
	
	<p>
	Puginier has received a good deal of attention 
	from various writers – starting with a pious and hefty hagiography by Father 
	Eugène Louvet as early as 1894.<sup>11</sup> To avoid unnecessary repetition 
	...
	launched its <i>mission de pacification</i>, an unforgiving campaign that 
	...
	costs this imposes’.<sup>12</sup> The fact is that in the years following 
	...
	leadership headed by Paul Puginier.</p>
	...
	confessional.<sup>13</sup> Armed resistance was significantly undermined by 
	the acquisition to the French cause of thousands of new Catholic converts 
	every year in the delta and its immediate periphery.</p>
	...
	1873 <i>coup de force </i>in Hanoi and played a decisive role in the 
	...
	ideas.<sup>14</sup> The long-term impact of his influence on the authorities 
	...
	French missionaries who subsequently penetrated Tonkin and its highlands.</p>
	
	<p><b>
	Puginier’s Notes</b></p>
	...
	circles. In Tonkin, he sent his famous ‘<i>Notes et renseignements</i>’ to 
	the colonial authorities on a regular basis, sometimes weekly.<sup>15</sup> 
	...
	Upper Tonkin, they deserve attention.<sup>16</sup></p>
	...
	vigorous dislike for the local mandarins and the educated elite or <i>
	lettrés</i>, whose politics he despised. He used the harshest words to 
	describe them: ‘tortuous, hidden, hypocritical, sweet, pretending to appear 
	weak in order to succeed’.<sup>18</sup> In the same vein Puginier, 
	...
	Christians (303,000 F)’.<sup>19</sup> The honourable man’s valuation of 
	...
	contrast with his evangelical commitment.</p>
	...
	as fearsome as has often been said and repeated? What should be done?’<sup>20</sup></p>
	...
	mercury, excellent varieties of tea consumed locally and unknown in Europe.<sup>21</sup></i></p>
	...
	to be the necessary strategic plan to strengthen France’s grip over Tonkin:</p>
	...
	immediately come to replace her.</i></p>
	...
	friendly elements inside the country to support French troops’.<sup>23</sup> 
	...
	as his action plan form the bulk of his letter, 13 of the 20 pages.</p>
	
	<p>
	Among these recommendations, some highlight 
	Puginier’s economic preoccupations:</p>
	<p>
	a French company should be set up on the model 
	of the ancient East India Company (<i>Compagnie des Indes</i>), and a pilot 
	...
	progressively replaced by the Romanised script of Vietnamese language (<i>quôc 
	ngu</i>,) – as was already being done in Cochin China – and that French be 
	...
	mandarins hostile to France would thus also be irrevocably undermined.</p>
	
	<p>
	It is interesting to note that the first of his 
	eight recommendations alone fills five pages. Puginier’s directive here is 
	clear-cut and leaves no room for doubt: ‘Christianise the country’ (<i>christianiser 
	le pays</i>). He asserts that ‘to unite men and peoples, there is no tie 
	...
	missionaries will be pivotal in this strategy:</p>
	<p><i>
	...
	Tonkin will be Christian, that is to say, French’.<sup>24</sup></p>
	...
	remaining loyal to France’.</p>
	
	<p>
	Puginier falls short of explaining exactly how 
	this is to be done, however, nor is the objective</p>
	<p>
	...
	necessary, give them monetary rewards.<sup>25</sup></i></p>
	...
	Tonkin – showed toward the non-Kinh populations, the ‘<i>demisauvages</i>’ 
	...
	the field – and, by the same token, to produce ‘ethnographic’ texts.</p>
	...
	to the Bishop’s <i>Notes</i>.<sup>28</sup></p>
	
	<p>
	Others had serious reservations, such as de 
	Lanessan (quoted above). Whatever the individual views, however, Puginier 
	was lauded for his dedication and relentless action in promoting France’s <i>
	grandeur</i>. Annam’s Resident Superior Brière declared at the Bishop’s 
	...
	‘France’s most authoritative representative in Tonkin’.<sup>29</sup> An 
	...
	the Cathedral, making the missionaries</p>
	<p>
	the most important private landlords in the 
	capital at the time. In France, Puginier – considered the man who had done 
	the most for the success of the French takeover in Tonkin – was made <i>
	Chevalier</i>, then <i>Officier </i>in the Legion of Honour.<sup>30</sup></p>
	...
	Frenchman had originally foreseen or called for.</p>
	</div>
	
	<hr>
	<p>
	9 Oscar Salemink, <i>The ethnography of 
	Vietnam’s Central Highlanders. A historical contextualization 1850–1990 </i>
	(London: RoutledgeCurzon Press, 2002); Vo Duc Hanh, <i>La place du 
	catholicisme dans les relations entre la France et le Viêt Nam de 1851 à 
	1871 </i>(Leiden: Brill, 1969).</p>
	<p>
	10 Cao Huy Thuan, <i>Les missionnaires et la 
	politique coloniale française au Vietnam (1857–1914) </i>(New Haven: Yale 
	Southeast Asian Studies, 1990).</p>
	<p>
	11 Louis Eugène Louvet, <i>Vie de Mgr Puginier, 
	Évèque de Mauricastre, Vicaire Apostolique du TonkinOccidental </i>(Hanoi: 
	...
	symbolic titles <i>in partibus</i>, which bore the names of ancient 
	...
	interchangeably.</p>
	<p>
	12 Jean-Marie-Antoine de Lanessan, <i>
	L’Indochine française, étude politique et administrative </i>(Paris: Alcan, 
	...
	Patrick Tuck, <i>French Catholic missionaries and the politics of 
	imperialism in Vietnam, 1857–1914: A documentary survey </i>(Liverpool: 
	Liverpool University Press, 1987), p. 338.</p>
	<p>
	13 Cao Huy Thuan, <i>Missionnaires et la 
	politique coloniale</i>, p. 282.</p>
	<p>
	14 De Lanessan, <i>Indochine française</i>, p. 
	715; Puginier’s relocation is mentioned in Charles-Edouard Hocquart, ‘Trente 
	mois au Tonkin’, <i>Tour du Monde</i>, 1st semester, 1890: 117.</p>
	<p>
	15 The recipients included the Governor-General, 
	the Commander-in-Chief, the Resident Superior in Tonkin, and various 
	Ministers in France; Gustave Monteuuis, <i>L’âme d’un missionnaire. Vie du 
	P. Nempon, missionnaire apostolique du Tonkin Occidental </i>(Paris: Victor 
	Retaux et Fils, 1895), p. 232 note 2. There are around 100 such letters kept 
	in the MEP archives in Paris (vol. 816).</p>
	<p>
	16 Cao Huy Thuan, <i>Missionnaires et la 
	politique coloniale</i>, p. 276.</p>
	<p>
	17 Note, 14 Aug. 1888; Puginier’s Notes, cited 
	here as ‘Note’, are held in the MEP Archives.</p>
	<p>
	18 Note, 26 June 1886.</p>
	<p>
	19 Note, 20 Aug. 1886.</p>
	<p>
	20 Note, Mar. 1887.</p>
	<p>
	...
	Huy Thuan, <i>Missionnaires et la politique coloniale</i>, pp. 289–90 and 
	Philippe Papin, <i>Histoire de Hanoi </i>(Paris: Fayard, 2001), p. 218. 
	...
	it to various authorities.</p>
	<p>
	22 Note, Mar. 1887.</p>
	<p>
	23 Ibid.; emphasis in the original.</p>
	<p>
	24 All quotations from ibid.</p>
	<p>
	...
	privileges, including the hereditary title of ‘Lord of Lai Châu’.</p>
	<p>
	26 In accordance with French colonial archives 
	and publications, the French term ‘<i>montagnards</i>’ – with lower-case ‘m’ 
	...
	June 1886, MEP, vol. 816, no. 58.</p>
	<p>
	28 Monteuuis, <i>Âme d’un missionnaire</i>, p. 
	231.</p>
	<p>
	29 Ibid., p. 233; Brière’s remarks are quoted in 
	Antoine Brebion, <i>Dictionnaire de bio-bibliographie générale, ancienne et 
	moderne, de l’Indochine française </i>(Paris: Société d’Éditions 
	Géographiques, Maritimes et Coloniales, 1935), p. 315.</p>
	<p>
	30 Cao Huy Thuan, <i>Missionnaires et la 
	politique coloniale</i>, p. 302; on the cathedral, see Papin, <i>Histoire de 
	Hanoi</i>, p. 241.</p>
...
<center class="trang"><a href="/LICHSU/indexLS" target="_blank">Trang Lịch SửửSử</a></center>
</td></tr>
	</tbody></table>
	</td></tr>
</tbody></table>
