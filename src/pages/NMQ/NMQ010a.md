...
<p>Date: September 19, 1999 (*) </p>
		<p>HIS HOLINESS POPE JOHN PAUL II</p>
			<p>VATICAN, ROME</p>
			<p>Your Holiness,</p>
			
			<p class="MsoBodyText">Throughout the last decade, we were very 
			...
			in the case of Galileo Galilei <sup>(1)</sup>, and towards the end 
			of 1994 Your Holiness called on Catholics to adopt a penitential 
			stance before entering the third millenium <sup>(2)</sup>. These 
			...
			nations victimized by the Church <sup>(3)</sup>. Furthermore, in 
			...
			<p>(i) <i>Heaven is not an abstraction nor a 
			physical place amid the clouds, but a living personal relationship 
			with the Holy Trinity </i><sup>(4)</sup>.</p>
			
			<p>(ii) <i>Hell is not a punishment imposed 
			extremely by God, but the condition resulting from attitudes and 
			actions which people adopt in this life </i><sup>(5)</sup><i>.</i></p>
			<p>On September 1<sup>st</sup>, 1999, Your 
			Holiness made a public apology “<i>for all the misdeeds, injustices, 
			and violations of human rights committed by the Church in the past”
			</i><sup>(6)</sup>. And most recently, on Friday, December 17, 
			...
			Father John Huss at the stake in 1415<sup>(7).</sup></p>
			
			<p>This has filled us with overwhelming exultation 
			...
			<p>Your Holiness, the wisdom of our ancestors lies 
			in the saying “W<i>eeds cannot be effectively eradicated if they are 
			not thoroughly uprooted”</i>. Your Holiness and the Church must have 
			...
			<p>In order to implement the above-mentioned 
			...
			possible for the sake of the Church’s prestige.</p>
			
			<p class="TuaDoLeft"> I. APROPOS OF THE 
			PAPACY AND THE RULING MACHINERY</p>
			
			<p>l. For the democratization of all governing 
			...
			<p>2. Abrogate all rituals that are inappropriate 
			...
			sandals and bishops’ rings.</p>
			
			<p>3. Desist using language and terms that smack 
			...
			(father), and address believers as “con” (Child/Children).</p>
			
			<p class="TuaDoLeft">
			 II.  APROPOS OF 
			POLITICAL POLICIES </p>
<p> AND AMORAL STRATEGIES FOR 
			THE DISSEMINATION OF CHRITIANITY</p>
			
			<p>1. Solemnly decree the immediate abolition 
			of the “Church powers above State powers” doctrine.</p>
			
			<p>2. Solemnly decree the immediate 
			...
			<p>3. Publicly condemn the Church’s decrees 
			...
			<p>4. Issue a decree unequivocally condemning 
			...
			states in North America and Western Europe.</p>
			
			<p>5. Solemnly decree the repeal of the 
			...
			<p class="TuaDoLeft"> III. APROPOS OF WHAT THE CHURCH 
			HAS DONE TO THE VIETNAMESE NATION </p>
			
			<p>1. Publish an official document solemnly 
			...
			the first half of the 16<sup>th</sup> century. These wrong doings 
			consisted of:</p>
			
			<p class="sub">a). Espionage activities through which 
			strategic intelligence information was collected and sent back to 
			the Vatican and the French colonialists <sup>(8)</sup></p>
			
			<p class="sub">b). Enticement of paupers, gangsters, and 
			...
			when they came to invade Vietnam,</p>
			
			<p class="sub">c). Dispatch to Vietnam of professional spies 
			...
			Vietnam. This campaign consisted of:</p>
			
			<p class="sub1">i. Alexandre de Rhodes, a priest who 
			campaigned with King Louis XIV in Paris in the 1650’s,</p>
			
			<p class="sub1">ii. Pigneau de Behaine, a bishop who took 
			Prince Canh, aged 4, to Paris in the mid-1780’s for 
			a campaign with King Louis XVI for 
			reinforcements to help Nguyen Anh fight Tay Son, </p>
			
			<p class="sub1">iii. Pellerin, a bishop, Legrand de Liraye, 
			...
			<p class="sub1">iv. Urging and aiding Bishop Pigneau de 
			...
			the subsequent invasion of Vietnam by the French,</p>
			
			<p class="sub1">v. Complicity with the French in scheming 
			...
			<p class="sub1">vi. Complicity with French General De 
			...
			Vatican-French Alliance. </p>
			
			<p>2. Issue an official statement 
			unequivocally condemning the following works:</p>
			<p class="sub1">a. “Day Four” chapter (on the Church’s 
			...
			Vietnamese religious beliefs), </p>
			<p class="sub1">b. The biblical book “The Daily Lessons 
			...
			than). We implore Your Holiness to ban the two books.</p>
			
			<p>3. Issue an official statement 
			...
			<sup>(9).</sup> Such teachings effectively destabilized the then 
			...
			<p>4. Issue an official statement solemnly 
			...
			Vatican to carry on her scheme to Catholicize South Vietnam.</p>
			
			<p>5. Issue an official statement solemnly 
			...
			<p>6. Issue an official statement solemnly 
			...
			impossible to heal. </p>
			
			<p>7. Issue an official statement repealing 
			...
			<p>8. Set up a commission to consider and 
			...
			Lederer, New York, W.W. Norton &amp; Company, 1968, p. 165).</p>
			
			
			<p>Your Holiness,</p>
			
			<p class="MsoBodyText">There have been fanatical Vietnamese 
			...
			apologies to the victims?</p>
			
			
			<p>Your Holiness,</p>
			
			<p>Your Holiness have courageously overcome 
			...
			will inevitably be raised:</p>
			
			<p>1. How can the Church fight for freedom 
			...
			impertinent, uncivilized and degrading?</p>
			
			<p>2. How can the Church fight for human 
			...
			<p>3. How can the Church honor freedom of 
			...
			of freedom of the press as “the most detrimental and disgusting”?</p>
			
			<p>4. How can the Church honor freedom of 
			...
			the Bible” by Saigon diocese as mentioned above?</p>
			
			<p>5. How can the Church fight for justice 
			...
			for the damage done?</p>
			
			
			<p>Your Holiness,</p>
			
			
			<p>A proverb has taught us that a single instance 
			...
			followers of other religion to their death. </p>
			
			<p>Your Holiness,</p>
			
			<p>“Repentance must accompany Penance”. We 
			...
			<p>Nguyen Manh Quang</p>
			<p>A person from one of the nations victimized by 
			the Roman Catholic Church</p>
			<p>7205 N. 25<sup>th</sup> Street</p>
			<p>Tacoma, WA. 98406 </p>
			<p>U.S.A.</p>
			
		<p>CC: All Nations and World Agencies.</p>
			<br clear="all" style="page-break-before:always">
<hr><p><b>NOTES</b></p>
			
			<p>(1) “Giao Hoi Cong Giao Da Nhin Nhan Sai Lam 
			Trong Vu An Galileo”. Chinh Nghia Weekly, No. 146, Nov. 7, 1992.</p>
			
			<p>(2) Paula Butturini, “Pope Wants Catholic 
			Church To Confess Its Sins”. Houston Chronicle, Tuesday, Nov. 15, 
			1994.</p>
			
			<p>(3) Chu Van Trinh &amp; Tuong Minh, “Roi Mat Na” 
			(Fallen Mask ). Tavares, Florida: Ban Tu Thu Tu Luc, 1998, back 
			cover page.</p>
			
			<p>(4) Hoc Hoi Giesu Kito Phuc Sinh. Tuyen Cao 
			8, Article 1, page 2.  <a href="https://www.ncregister.com/site/article/heaven_is_an_intimate_relationship_with_god_not_a_place_says_pope">Và link bài báo tiếng Anh  https://www.ncregister.com/... a_place_says_pope</a></p>
			
			<p>(5) Jude Webber. “No Fire or Brimstone, But 
			Hell’s Real, Pope Says.” Houston Chronicle, July 29, 1999, p. 26A.</p>
			
			<p>(6) “Duc Giao Hoang Jean-Paul II: Giao Hoi 
			Cong Giao Se xin Loi ve Qua Khu”. Nguoi Viet Tay Bac, No. 807, Sept. 
			7, 1999.</p>
			
			<p>(7) “Pope John Paul II apologized…” The News 
			...
			tree outside St. Peter’s that is to be lighted today.” </p>
			
			<p>(8) Avro Manhattan, “Vietnam, Why Did We Go?” 
			Chino, CA: Chick Publication, 1984, p. 139.</p>
			
			<p>(9) Nguyen Xuan Tho, “Buoc Mo Dau Cua Su 
			Thiet Lap He Thong Thuoc Dia Phap O Vietnam (1858-1897). Published 
			by the author, 1995, p. 17. </p>
			
		<p>(*) January 10, 2000: Translated from 
			Vietnamese version and updated the latest apology of the Pope.</p>
 ...
 <font size="2">
<p> 
	<a href="/NMQ/NMQ007">Gửi Quý vị Tu sĩ Ca-tô và giáo dân người Việt (Nguyễn Mạnh Quang)</a></p>
